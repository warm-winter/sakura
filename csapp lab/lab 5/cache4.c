...
/* Type: Memory address */
typedef unsigned long long int mem_addr_t;//64位长整型数bai据类型
...
模拟器的关键功能是访问内存地址addr和相应地改变了结构用于实现缓存。 */
...
//replayTrace - replays the given trace file against the cache replayTrace-针对缓存重播给定的跟踪文件
