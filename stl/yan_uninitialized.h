...
#ifndef SAKURA_YAN_UNINITIALIZED_H
#define SAKURA_YAN_UNINITIALIZED_H
...
__STL_BEGIN_NAMESPACE
    ...
    inline _ForwardIte __uninitialized_copy(_InputIter __first,_InputIter __last,_ForwardIter __result,_Tp*){
        typedef typename __type_traits<_Tp>::is_POD_type _Is_POD;
        return __uninitialized_copy__aux(__first,__last,__result,_Is_POD());
}
...
#endif //SAKURA_YAN_UNINITIALIZED_H
